...
// Elemento: 
// 
// - Guarda la información de los distintos elementos
//******************************************************************************
...
struct Nodo {
    ...
    double BE;                  // Beneficio estimado
    int nivel;                  // Nivel de profundidad en el que se encuentra
    double valor_actual;        // Beneficio actual real
    double peso_actual;         // Peso actual de la mochila
    vector<bool> tupla;
...
//******************************************************************************
// Algoritmo de la mochila fraccional:
//
// - Algoritmo greedy para el cálculo de la mochila fraccional a partir del 
//   estado que se le pasa. Se usa para calcular cotas.
//******************************************************************************
...
//
// - Algoritmo greedy para el cálculo de la mochila 0/1 a partir del estado que 
//   se le pasa. Se usa para calcular cotas.
//******************************************************************************
...
// NodoInicial:
//
// Genera el nodo inicial para el problema.
//
//******************************************************************************
...
// Generar:
//
// - Genera el siguiente nodo correspondiente al nodo actual y la elección que 
//   se ha hecho
//******************************************************************************
...
//
// - Ejecuta el algoritmo de la mochila y devuelve un vector de bool indicando
//   qué objetos y cuales no se meten en la mochila.
//******************************************************************************
